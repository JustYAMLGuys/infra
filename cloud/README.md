...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_headsccale-server"></a> [headsccale-server](#module\_headsccale-server) | ./aws/headscale-server | n/a |
| <a name="module_middleware"></a> [middleware](#module\_middleware) | ./aws/middleware | n/a |
